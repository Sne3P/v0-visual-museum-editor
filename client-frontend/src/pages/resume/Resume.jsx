...
const Resume = () => {
    ...
    // Vérifier que le parcours contient des œuvres
    if (!parcours.artworks || parcours.artworks.length === 0) {
        return (
            <div className="error-container">
                <div className="error-card">
                    <h2>❌ Aucune œuvre disponible</h2>
                    <p>Impossible de générer un parcours.<br/>Veuillez modifier vos critères et réessayer.</p>
                    <button 
                        className="btn-back"
                        onClick={() => navigate('/mes-choix')}
                    >
                        ← Retour
                    </button>
                </div>
